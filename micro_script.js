...
const QUIZ_SECTION_CONFIGS = {
  micro: {
    ...
    description: 'Раздел с тестами по финансовым рискам',
    themeFiles: [
      ...
      { file: '201-231.json', label: 'Вопросы 201-231' },
      { file: 'micro_tests.json', label: 'Все вопросы (231)', default: true }
    ],
    totalQuestionCount: 231
  }
};
...
<div class="card">
    ...
    <div class="mode-switch" id="test-mode-switch">
        ...
        <button type="button" class="mode-switch-btn" data-mode="speed"><span class="mode-switch-label">На скорость</span><span class="mode-lock" data-mode-lock aria-hidden="true"></span></button>
        <button type="button" class="mode-switch-btn" data-mode="untimed"><span class="mode-switch-label">Без времени</span><span class="mode-lock" data-mode-lock aria-hidden="true"></span></button>
    </div>
